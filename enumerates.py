...
class TextLabels(enum.Enum):
    ...
    CREATION_HELP_REQUEST = 145
    CREATION_HELP_RULES = 146

    MODERATION_UNREGISTERED = 201
    MODERATION_GREETING = 202
    MODERATION_ACCESS_DENIED = 203
    MODERATION_SEND_DRAFT = 204
    MODERATION_GET_ALL_TAGS = 205
    MODERATION_GET_TAG_INFO = 206
    MODERATION_TAG_STATE_SWITCHED = 207
    MODERATION_WRONG_TAG_CODE = 208
    MODERATION_TAG_CODE_VALUE_ERROR = 209
    MODERATION_TAG_NOT_ALL_LANGUAGES = 210
    MODERATION_TAG_DUPLICATE_VALUE = 211
    MODERATION_TAG_ADDED = 212
    MODERATION_TAG_DELETED = 213
    MODERATION_INVALID_USER_ID = 214
    MODERATION_M_STATUS_ASSIGNED = 215
    MODERATION_A_STATUS_ASSIGNED = 216
    MODERATION_GET_ALL_USERS_DATA = 217
    MODERATION_GET_ALL_REQUESTS_DATA = 218
