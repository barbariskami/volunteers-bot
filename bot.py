...
class Bot:
    ...
    def register(media, user_id, password, user_contact_link=''):
        ...
        ется обратиться на почту сервиса.
        :param user_contact_link:
        :param media:
    ...
    def handle_message(cls, media, message, creation=False):
        """
         ...
         меню или меню выбора черновика задачи) и запускает обработчик сообщения, соответствующий состоянию пользователя
        :param media:
        :param message:
        :param creation:
        :return:
